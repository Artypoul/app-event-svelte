...
<main id="main-content" class="font-sans antialiased">
  ...
  <section class="py-20 sm:py-24 lg:py-28 bg-charcoal" aria-labelledby="guests-title">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-12 sm:mb-16 reveal">
        <h2 id="guests-title" class="font-serif text-3xl sm:text-4xl md:text-5xl text-white mb-4 sm:mb-5 leading-tight">Работа со статусными гостями</h2>
        <p class="text-gray-400 max-w-2xl mx-auto leading-relaxed text-base sm:text-lg">Мы знаем специфику работы с публичными персонами, политиками и звёздами шоу-бизнеса.</p>
      </div>
      <div class="flex flex-col lg:flex-row gap-6 sm:gap-8 items-stretch">
        <div class="w-full lg:w-2/3 relative group overflow-hidden rounded-sm reveal">
          <img src="https://image.qwenlm.ai/public_source/66673185-31fc-400c-9758-01d949190730/16d75ab75-af4f-40bb-8aec-d9bdf3a7418c.png" alt="VIP гость" class="w-full h-[400px] sm:h-[450px] lg:h-[500px] object-cover grayscale group-hover:grayscale-0 transition-all duration-700" loading="lazy">
          <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
        </div>
        <div class="w-full lg:w-1/3 flex flex-col gap-4 sm:gap-5 reveal reveal-delay-200">
          <div class="bg-slate p-5 sm:p-6 border-l-2 border-gold"><h4 class="text-white font-serif text-lg sm:text-xl mb-2">Инкогнито</h4><p class="text-gray-400 text-sm leading-relaxed">Заселение под вымышленными именами и закрытая логистика.</p></div>
          <div class="bg-slate p-5 sm:p-6 border-l-2 border-gold"><h4 class="text-white font-serif text-lg sm:text-xl mb-2">Anti-Paparazzi</h4><p class="text-gray-400 text-sm leading-relaxed">Блокировка несанкционированной съёмки и периметр безопасности.</p></div>
          <div class="bg-slate p-5 sm:p-6 border-l-2 border-gold"><h4 class="text-white font-serif text-lg sm:text-xl mb-2">Личные райдеры</h4><p class="text-gray-400 text-sm leading-relaxed">Соблюдение индивидуальных требований гостей.</p></div>
        </div>
      </div>
    </div>
  </section>

  <section class="py-20 sm:py-24 lg:py-28 bg-dark" aria-labelledby="testimonials-title">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <h2 id="testimonials-title" class="font-serif text-3xl sm:text-4xl text-center text-white mb-12 sm:mb-16 reveal">Что говорят клиенты</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        <div class="bg-charcoal p-6 sm:p-8 relative reveal"><p class="text-gray-300 italic leading-relaxed">«Единственное агентство, которое понимает значение слова “секретность”.»</p></div>
        <div class="bg-charcoal p-6 sm:p-8 relative reveal reveal-delay-100"><p class="text-gray-300 italic leading-relaxed">«Деликатность персонала на высшем уровне.»</p></div>
        <div class="bg-charcoal p-6 sm:p-8 relative reveal reveal-delay-200"><p class="text-gray-300 italic leading-relaxed">«Полный контроль над ситуацией.»</p></div>
      </div>
    </div>
  </section>
